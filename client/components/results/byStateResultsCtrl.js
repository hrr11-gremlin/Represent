(function() {
    ...
    .controller('ByStateResultsController', ['$scope', 'SendRequest', '$rootScope', 'searchFactory', '$state', 'DataCache', 
        function($scope, SendRequest, $rootScope, searchFactory, $state, DataCache) {
