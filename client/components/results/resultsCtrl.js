(function() {
  ...
  .controller('ResultsController',['$scope', '$rootScope', 'searchFactory','resultsFactory', 
    function($scope, $rootScope, searchFactory, resultsFactory){
  ...
  .run(['$rootScope', 'resultsFactory', function($rootScope, resultsFactory){
    var init = function(){
